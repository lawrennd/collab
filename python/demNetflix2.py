...
for iter in range(numIters):
    ...
    state[1].tofile(os.path.join(iterDir, "state1_" + state[0] + "_" +  str(state[2]) + "_" + str(state[3])))
    np.array(state[4]).tofile(os.path.join(iterDir, "state4_" + state[0] + "_" +  str(state[2]) + "_" + str(state[3])))
    ...
    for user in userOrder:
        ...
        XXchange = XXchange*momentum + X*learnRate 
        # update X
