function [] = demMovieLensMarlinStrongLinearScript1(substract_mean, partNo_v, latentDim_v,iters, inverted)
% DEMMOVIELENSMARLINSTRONGLINEARSCRIPT1 Try collaborative filtering on the Movielens data with
% Marlins partitions
% where the strong movielens experiment
%
  % demMovieLensMarlinStrongLinearScript1(substract_mean, partNo_v,
