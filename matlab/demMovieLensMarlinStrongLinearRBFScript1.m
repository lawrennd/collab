...
% FORMAT  
% DESC  Try collaborative filtering on the EachMovie data with
% Marlin's partitions for the strong generalization with the rbf and
...
for i_latent=1:length(latentDim_v)
  ...
  for i_part=1:length(partNo_v)
    ...
    % change the options to have a linear and kernel
