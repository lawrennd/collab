function [] = demEachMovieMarlinWeakEnsemScript1(substract_mean, partNo_v, latentDim_v,iters, inverted, type)
% DEMEACHMOVIEMARLINWEAKENSEMSCRIPT1 Ensemble of models on Marlin's weak Eachmovie partions.
% FORMAT
% DESC Try collaborative filtering on the Eachmovie data with ensembles for
% Marlin's partitions for weak generalization.
...
save(saveResults, 'allModels', 'L2_error','NMAE_error','NMAE_round_error','modelsActive');
    end
